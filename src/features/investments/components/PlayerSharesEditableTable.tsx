...
import { createPlayerSharesEditableTableSchema } from '../table-schemas';

export const PlayerSharesEditableTable = () => {
  const sharesTableRowCount =
    usePlayerFinances((s) => Object.keys(s.draft.shares ?? {}).length) + 1;

  const schema = createPlayerSharesEditableTableSchema(sharesTableRowCount);
