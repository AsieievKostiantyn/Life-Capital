...
create or replace function update_investment_terms(
  p_deal_id uuid,
  p_user_id uuid,
  p_notes text
)
...
begin
  if not exists (
    ...
    raise exception 'Only owner can sell investment';
  end if;
