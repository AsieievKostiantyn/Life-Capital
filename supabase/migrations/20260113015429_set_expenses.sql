create or replace function public.set_expense(
...
begin
    ...
    set expenses_list = array_append(expenses_list, v_card.id)
...
create or replace function public.set_big_expense(
    p_game_session_id uuid,
    p_user_id uuid
)
returns void
